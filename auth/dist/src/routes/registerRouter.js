...
import { accessToken, UserDTO, userModelForRegistration, } from "../models/userModel";
import { jwtConfig } from "../config/jwtConfig";
export const registerRouter = new Elysia().use(jwtConfig).post("/register", async ({ body, error, jwt_auth }) => {
    ...
    if (!newUser)
        return error(400, "Problems creating user");
